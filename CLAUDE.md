...
Interactive cabana booking webapp for a resort. **No implementation exists yet — this is a specification + assets repo.** Languages allowed: **.NET and/or JavaScript/TypeScript** only.
